...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        bootloader: {
            options: {
                projectPrefix: "rudrax-boot-loader", //packages with this prefic will have preferences, it tells me that `myapp` needs to be bundeled first
                sort: false,
                indexBundles: ["webmodules/bootloader", "rudrax-boot-loader/app"],
                src: "./",
                dest: "dist",
                ...
                bootServer: {
                    port: 8087,
                    indexMatch: /^\/rudrax-boot-loader\// //URLs to be used to render index.html
                }
            }
        },
        jshint: {
        ...
        cssmin: {
            options: {
                target: "rudrax-boot-loader/dist/css",
                advanced: true,
